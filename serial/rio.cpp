...
static ssize_t rio_read(rio_t *rp, unsigned char *usrbuf, size_t n)
/**
...
ssize_t rio_readnb(rio_t *rp, unsigned char *usrbuf, size_t n)
/**
 ...
 */
{
	size_t leftcnt = n;
	ssize_t nread;
	unsigned char *buf = (unsigned char *)usrbuf;
 ...
 */
{
	size_t n;
	int rd;
	unsigned char c, *bufp = (unsigned char *)usrbuf;
